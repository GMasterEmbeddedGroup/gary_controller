...
CallbackReturn DualLoopPIDControllerWithFilter::on_configure(const rclcpp_lifecycle::State &previous_state) {
    ...
    if (!this->check_parameter("inner_p_filter_coefficient", rclcpp::ParameterType::PARAMETER_DOUBLE)) {
        return CallbackReturn::ERROR;
    }
    ...
    if (!this->check_parameter("inner_d_filter_coefficient", rclcpp::ParameterType::PARAMETER_DOUBLE)) {
        return CallbackReturn::ERROR;
    }
    ...
    if (!this->check_parameter("outer_p_filter_coefficient", rclcpp::ParameterType::PARAMETER_DOUBLE)) {
        return CallbackReturn::ERROR;
    }
    ...
    if (!this->check_parameter("outer_d_filter_coefficient", rclcpp::ParameterType::PARAMETER_DOUBLE)) {
        return CallbackReturn::ERROR;
    }
...
bool DualLoopPIDControllerWithFilter::check_parameter(const std::string &name, rclcpp::ParameterType type) {
